...
<p align="center">
  ...
  <strong>omm closes the gap — architecture docs, generated by AI, for humans.</strong><br/>
  <em>Supports Mermaid, D3, PlantUML, and more diagram formats.</em>
</p>
...
| Any AI tool | `omm setup` (auto-detect) |
...
- Enhanced features from [DandyLyons/treedocs](https://github.com/DandyLyons/treedocs) (drift detection, reconciliation, coverage mapping)
- Improved validation, scoring, and AI tool integration
